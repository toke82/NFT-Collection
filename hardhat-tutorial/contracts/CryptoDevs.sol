...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    */
    ...
    /**
     * @dev presaleMint allowes a user to Mint one NFT per transaction during the presale
     */
    ...
    function mint() public payable onlyWhenNotPaused {
        ...
        require(tokenIds < maxTokenIds, "Exceed maximum Crypto Dev supply");
        require(msg.value >= _price, "Ether sent is not correct");
        tokenIds += 1;
        _safeMint(msg.sender, tokenIds);
    }
    ...
    // Function to received Ether, msg.data must be empty
